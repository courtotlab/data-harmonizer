...
@pytest.mark.parametrize("str_repre_1, num_syn_1, expected_lst_1", param_retry_gen_data)
def test_retry_gen_data(str_repre_1, num_syn_1, expected_lst_1):
    """Test data_harmonizer.data.synthetic_data.retry_gen_data"""

    def llm_call(*args, **kwargs):
        return str_repre_1

    actual = retry_gen_data(llm_call, "pass", num_syn_1, 3)
...
param_get_gen_row_data_dict = [
    (  # base example
        {"field_name": "field_name_1", "field_description": "field_description_1"},
        {
...
@pytest.mark.parametrize(
    "tuple_dict_2, patch_retry_gen_data_2, expected_dict_2", param_get_gen_row_data_dict
)
def test_get_gen_row_data_dict(
    ...
    monkeypatch.setattr(
        data_harmonizer.data.synthetic_data,
        "retry_gen_data",
